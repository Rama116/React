...
const Contact = () => {
  return (
    ...
    <div className="h-screen w-full flex flex-col md:flex-row">
        <div className="h-[50%] md:h-[70%] w-full md:w-[40%] text-3xl md:text-5xl font-serif flex flex-col justify-center items-center gap-4 md:gap-8">
        ...
        <div className="h-auto md:h-[80%] w-full md:w-[25%] flex flex-col justify-center p-6 md:p-9">
