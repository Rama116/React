  ...
  return (
    <>
      <div className="w-full min-h-screen flex flex-col fixed ">
        {/* <NavBar appname={[1,2,3,"rama"]} /> */}
        <NavBar />
      </div>
        
      <div className="flex h-screen w-screen justify-center items-center bg-green-200 overflow-hidden">

      <div className="h-4/6 w-[30%] flex justify-center items-center bg-green-100 relative">
        <h1 className="absolute top-[5%] text-black text-2xl font-bold">Login Form</h1>
